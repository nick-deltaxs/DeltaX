    ...
    <div className="bg-primary min-h-screen pt-32 pb-16">
      <div className="max-w-[720px] mx-auto px-6">
        ...
        <section className="mb-12">
          ...
          <p className="font-body text-base text-text-body leading-[1.8] mb-4">
        ...
        <section className="mb-12">
          ...
          <ul className="space-y-3 mb-4">
            <li className="font-body text-base text-text-body leading-[1.8] pl-4 border-l-[3px] border-core-bright/30">
