...
export function ContactHero() {
  return (
    <ScrollReveal delay={0}>
      <section className="bg-primary relative overflow-hidden atmosphere-grid atmosphere-vignette">
        {/* Minimal teal atmosphere */}
        <div 
          className="absolute inset-0"
          style={{
            background: 'radial-gradient(ellipse at center, rgba(26, 155, 191, 0.05) 0%, transparent 70%)'
          }}
        />
        
        {/* Content */}
        <div className="relative max-w-4xl mx-auto px-6 lg:px-8 text-center py-24 lg:py-32">
          {/* Headline */}
          ...
          <div className="text-sm text-text-muted text-center mt-1">
            Bali, Indonesia
          </div>
